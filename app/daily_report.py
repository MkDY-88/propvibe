...
SYSTEM_PROMPT = (
    ...
    "instead of padding.\n\n"
    "When comparing two numbers, either state the plain values (e.g. \"12.0 "
    "vs 2.77\") or compute the ratio precisely first and only then state it "
    "as a multiplier (12.0 vs 2.77 is about 4.3x, so never call it \"double\" "
    "or \"triple\") - NEVER estimate a ratio in prose. If you are not certain "
